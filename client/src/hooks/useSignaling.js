...
const WS_ENDPOINT = import.meta.env.VITE_WS_ENDPOINT || `http://${window.location.hostname}:5000`;
 ...
 */
export function useSignaling({ onQueueUpdated, onIncomingCall, onOffer, onAnswer, onIceCandidate } = {}) {
